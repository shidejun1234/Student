	...
	rownumbers="true" fitColumns="true" url="studentList" toolbar="#tb">
		<thead>
			<tr>
				...
				<th data-options="field:'stuId',width:50,align:'center'">编号</th>
				<th data-options="field:'stuNo',width:80,align:'center'">学号</th>
				...
				<th data-options="field:'gradeId',width:80,align:'center'">班级编号</th>
				<th data-options="field:'email',width:200,align:'center'">email</th>
				<th data-options="field:'stuDesc',width:200,align:'center'">学生描述</th>
			</tr>
		</thead>
	</table>
